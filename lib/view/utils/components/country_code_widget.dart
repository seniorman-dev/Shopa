...
class _CountryCodeWidgetState extends State<CountryCodeWidget> {
  ...
  Widget build(BuildContext context) {
    return CountryCodePicker(
      ...
      textStyle: GoogleFonts.hind(color: AppColor.greyColor, fontSize: 14.sp, fontWeight: FontWeight.w400),
      dialogTextStyle: GoogleFonts.hind(color: AppColor.blackColor, fontSize: 14.sp, fontWeight: FontWeight.w400),
